...
import generated.mutiny.reactive.mysql.Tables;
import generated.mutiny.reactive.mysql.enums.SomethingSomeenum;
import generated.mutiny.reactive.mysql.tables.daos.SomethingDao;
import generated.mutiny.reactive.mysql.tables.pojos.Something;
...
public class SomethingDaoTest extends MutinyTestBase<Something, Integer, Long, SomethingDao> {
    ...
    public SomethingDaoTest() {
        super(Tables.SOMETHING.SOMEHUGENUMBER, new SomethingDao(MySQLConfigurationProvider.getInstance().createDAOConfiguration(), ReactiveMysqlDatabaseClientProvider.getInstance().mutinyGetClient()));
    }
    ...
    protected void assertDuplicateKeyException(Throwable x) {
        assertException(MySQLException.class, x, pgException -> Assert.assertEquals(1062, pgException.getErrorCode()));
    }
