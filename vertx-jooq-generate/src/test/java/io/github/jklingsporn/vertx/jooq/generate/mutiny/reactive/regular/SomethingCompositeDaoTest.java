...
import generated.mutiny.reactive.regular.Tables;
import generated.mutiny.reactive.regular.tables.daos.SomethingcompositeDao;
import generated.mutiny.reactive.regular.tables.pojos.Somethingcomposite;
 ...
 */
public class SomethingCompositeDaoTest extends MutinyTestBase<Somethingcomposite, Record2<Integer,Integer>, JsonObject, SomethingcompositeDao> {


    public SomethingCompositeDaoTest() {
        super(Tables.SOMETHINGCOMPOSITE.SOMEJSONOBJECT, new SomethingcompositeDao(PostgresConfigurationProvider.getInstance().createDAOConfiguration(), ReactiveDatabaseClientProvider.getInstance().mutinyGetClient()));
    }
